...
export default class ActionBar extends Component {
  ...
  render() {
    return(
      <div id="action-bar2" className="col-md-12">
        <div className="navi col-md-3">
        ...
        <div className="action-input col-md-7">
        ...
        <div className="preferences col-md-2" onClick={this.handleProfileClick}>
